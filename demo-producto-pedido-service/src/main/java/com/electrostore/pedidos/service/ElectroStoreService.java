...
public class ElectroStoreService {
    ...
    private final ProductoCustomRepositoryImpl productoCustomRepository;

    ElectroStoreService(ProductoRepository productoRepository, PedidoRepository pedidoRepository, ProductoCustomRepositoryImpl productoCustomRepository) {
